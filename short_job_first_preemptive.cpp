...
void short_job_first_preemptive::on_next_pushButton_clicked()
{
...
void short_job_first_preemptive::on_back_pushButton_clicked()
{
    int process_no = ui->process_no_label->text().toInt();
...
void short_job_first_preemptive::schedule_processess(QLinkedList<process> &timeline){
...
void short_job_first_preemptive::draw_timeline(const QLinkedList<process> &timeline){
