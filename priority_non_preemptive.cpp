...
void priority_non_preemptive::on_next_pushButton_clicked()
{
...
void priority_non_preemptive::on_back_pushButton_clicked()
{
    int process_no = ui->process_no_label->text().toInt();
...
void priority_non_preemptive::schedule_processess(QLinkedList<process> &timeline){
    int i;
    ...
    for (i = 0; i < number_of_processes; i++){
        ...
        highest_prority_process_id = get_highest_priority_process_id(current_processes_running_now);
...
void priority_non_preemptive::draw_timeline(const QLinkedList<process> &timeline){
